...
describe BudgetPostsController do
  describe "routing" do
    ...
    it "routes to #edit" do
      expect(get("/budget_posts/1/edit")).to route_to("budget_posts#edit",
                                                      id: "1")
    end
    ...
    it "routes to #update" do
      expect(put("/budget_posts/1")).to route_to("budget_posts#update",
                                                 id: "1")
    end

    it "routes to #destroy" do
      expect(delete("/budget_posts/1")).to route_to("budget_posts#destroy",
                                                    id: "1")
    end
  end
end
