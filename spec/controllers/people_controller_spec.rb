    ...
    describe 'POST create' do
      ...
      describe 'with valid params' do
        it 'assigns a newly created person as @person' do
          allow(Person).to receive(:new).with('these' => 'params') { mock_person(save: true) }
      ...
      describe 'with invalid params' do
        it 'assigns a newly created but unsaved person as @person' do
          allow(Person).to receive(:new).with('these' => 'params') { mock_person(save: false) }
          post :create, person: { 'these' => 'params' }
          expect(assigns(:person)).to be(mock_person)
        end
    ...
    describe 'PUT update' do
      describe 'with valid params' do
        it 'updates the requested person' do
          expect(Person).to receive(:find).with('37') { mock_person }
          expect(mock_person).to receive(:update_attributes).with('these' => 'params')
          put :update, id: '37', person: { 'these' => 'params' }
        end

        it 'assigns the requested person as @person' do
          allow(Person).to receive(:find) { mock_person(update_attributes: true) }
          put :update, id: '1'
          expect(assigns(:person)).to be(mock_person)
        end
      ...
      describe 'with invalid params' do
        it 'assigns the person as @person' do
          allow(Person).to receive(:find) { mock_person(update_attributes: false) }
          put :update, id: '1'
          expect(assigns(:person)).to be(mock_person)
        end
