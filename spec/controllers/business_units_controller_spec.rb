    ...
    describe 'POST create' do
      describe 'with valid params' do
        it 'assigns a newly created business_unit as @business_unit' do
          allow(BusinessUnit).to receive(:new).with('these' => 'params') { mock_business_unit(save: true) }
          post :create, business_unit: { 'these' => 'params' }
          expect(assigns(:business_unit)).to be(mock_business_unit)
        end

        it 'redirects to the created business_unit' do
          allow(BusinessUnit).to receive(:new) { mock_business_unit(save: true) }
      ...
      describe 'with invalid params' do
        it 'assigns a newly created but unsaved business_unit as @business_unit' do
          allow(BusinessUnit).to receive(:new).with('these' => 'params') { mock_business_unit(save: false) }
          post :create, business_unit: { 'these' => 'params' }
          expect(assigns(:business_unit)).to be(mock_business_unit)
        end

        it "re-renders the 'new' template" do
          allow(BusinessUnit).to receive(:new) { mock_business_unit(save: false) }
          post :create, business_unit: {}
    ...
    describe 'PUT update' do
      describe 'with valid params' do
        it 'updates the requested business_unit' do
          ...
          expect(mock_business_unit).to receive(:update_attributes).with('these' => 'params')
          put :update, id: '37', business_unit: { 'these' => 'params' }
        end

        it 'assigns the requested business_unit as @business_unit' do
          allow(BusinessUnit).to receive(:find) { mock_business_unit(update_attributes: true) }
          put :update, id: '1'
          expect(assigns(:business_unit)).to be(mock_business_unit)
        end
      ...
      describe 'with invalid params' do
        it 'assigns the business_unit as @business_unit' do
          allow(BusinessUnit).to receive(:find) { mock_business_unit(update_attributes: false) }
          put :update, id: '1'
          expect(assigns(:business_unit)).to be(mock_business_unit)
        end
